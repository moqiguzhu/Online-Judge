...
if hasattr(dict, 'iteritems'):
    ...
    def _iteritems(d): return d.iteritems()
    def _iterkeys(d): return d.iterkeys()
    ...
    def _sorted_iteritems(d): return sorted(
        d.items())  # pylint: disable=invalid-name

    def _iteritems(d): return iter(d.items())  # pylint: disable=invalid-name
    def _iterkeys(d): return iter(d.keys())  # pylint: disable=invalid-name
